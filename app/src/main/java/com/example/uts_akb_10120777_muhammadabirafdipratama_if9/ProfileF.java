    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivInstagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ig.setData(Uri.parse("https://www.instagram.com/abi_wiraatmadja/"));
                startActivity(ig);
            }
        });
        ...
        ivTwitter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tw.setData(Uri.parse("https://twitter.com/abi_wiraatmadja"));
                startActivity(tw);
            }
        });
        ...
        ivGmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gm.setData(Uri.parse("mailto:pratamaabi28@gmail.com"));
                startActivity(gm);
            }
        });
