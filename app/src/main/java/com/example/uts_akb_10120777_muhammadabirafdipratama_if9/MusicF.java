...
import com.example.uts_akb_10120777_muhammadabirafdipratama_if9.Adapter.MusicAdapter;
import com.example.uts_akb_10120777_muhammadabirafdipratama_if9.Model.MusicModel;
...
public class MusicF extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MusicModel music1 = new MusicModel(R.drawable.bp, "Blackpink Full Album", "Black Pink");
        musicModel.add(music1);
        MusicModel music2 = new MusicModel(R.drawable.nm, "Nevrmind Album", "Nirvana");
        musicModel.add(music2);
        MusicModel music3 = new MusicModel(R.drawable.oasis, "(What's the Story) Morning Glory ? Album", "Oasis");
